    ...
    <section id="contact">
      <div className="contact-bg">
        <div className="container">
            <h1 style={{ textAlign: "center", color: "#d05700"}}>Contact</h1>
          <p style={{textAlign:"center"}}>Feel free to contact via email or check out my other social links below!</p>
          <div className="social-links">
            <ul>
              <li><span style={{color:"cyan"}}>Email</span>: okelleynp "at" gmail.com</li>
